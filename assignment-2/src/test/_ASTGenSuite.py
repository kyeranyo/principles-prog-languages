...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_program_17(self):
        ...
        expect = """Program([
	VarDecl(var, StringType, StringLit(hello world))
	FuncDecl(main, VoidType, [], None, BlockStmt([BlockStmt([VarDecl(var, IntegerType, IntegerLit(1))]), IfStmt(BinExpr(>, Id(a), IntegerLit(0)), BlockStmt([VarDecl(var2, IntegerType, IntegerLit(2))])), DoWhileStmt(BinExpr(==, Id(n), IntegerLit(0)), BlockStmt([ReturnStmt(BooleanLit(False))])), AssignStmt(Id(var), BinExpr(::, StringLit(Lau Dai Tinh Ai), Id(var))), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(<, Id(i), Id(n)), BinExpr(+, Id(i), IntegerLit(1)), BlockStmt([])), CallStmt(test, IntegerLit(123), Id(ytx), BinExpr(+, BinExpr(+, BinExpr(+, IntegerLit(5), IntegerLit(2)), IntegerLit(5)), IntegerLit(5)))]))
])"""
	...
	VarDecl(var, StringType, StringLit(hello world))
	FuncDecl(fact, AutoType, [Param(alpha, StringType), Param(delta, IntegerType)], None, BlockStmt([IfStmt(BinExpr(<, Id(a), Id(b)), ReturnStmt(BooleanLit(True)), ReturnStmt(BinExpr(+, IntegerLit(1), FuncCall(fact, [BinExpr(+, BinExpr(+, IntegerLit(1), IntegerLit(1)), IntegerLit(2))]))))]))
	FuncDecl(main, VoidType, [], None, BlockStmt([DoWhileStmt(BinExpr(==, Id(n), IntegerLit(0)), BlockStmt([BlockStmt([VarDecl(a, FloatType, FloatLit(1211240000000.0))]), BlockStmt([VarDecl(b, FloatType, FloatLit(0.0001124141012))]), BlockStmt([VarDecl(c, FloatType, FloatLit(1.212481e-06))]), ReturnStmt(BooleanLit(False))])), AssignStmt(Id(var), BinExpr(::, StringLit(Lau Dai Tinh Ai), Id(var))), ForStmt(AssignStmt(Id(i), BinExpr(+, Id(a), Id(b))), BinExpr(<, Id(i), BinExpr(+, Id(n), IntegerLit(1))), BinExpr(-, BinExpr(+, Id(i), BinExpr(*, Id(a), Id(b))), BinExpr(/, IntegerLit(2), IntegerLit(10))), BlockStmt([ReturnStmt(StringLit(chac khong co tren tran gian))])), CallStmt(test, IntegerLit(123), Id(ytx), BinExpr(+, BinExpr(+, BinExpr(+, IntegerLit(5), IntegerLit(2)), IntegerLit(5)), IntegerLit(5)))]))
])"""
    ...
    def test_program_25(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([BlockStmt([VarDecl(a, AutoType, FloatLit(1.2128431e-09))]), AssignStmt(Id(var), BinExpr(-, BinExpr(+, BinExpr(%, Id(se), IntegerLit(10)), IntegerLit(10)), IntegerLit(1))), WhileStmt(BinExpr(>, Id(acn), BinExpr(+, IntegerLit(10), IntegerLit(1))), BlockStmt([AssignStmt(Id(s), BinExpr(+, Id(l), IntegerLit(1))), ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(>, Id(j), IntegerLit(0)), BinExpr(+, Id(c), IntegerLit(1)), BlockStmt([ReturnStmt(BinExpr(+, Id(a), FuncCall(fact, [IntegerLit(12)])))]))]))]))
])"""
    ...
    def test_program_27(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([BlockStmt([VarDecl(a, AutoType, FloatLit(1.2128431e-09))]), AssignStmt(Id(var), BinExpr(-, BinExpr(+, BinExpr(%, Id(se), IntegerLit(10)), IntegerLit(10)), IntegerLit(1))), BlockStmt([VarDecl(a, AutoType, StringLit(string))]), WhileStmt(BinExpr(>, Id(acn), BinExpr(+, IntegerLit(10), IntegerLit(1))), BlockStmt([AssignStmt(Id(s), BinExpr(+, Id(l), IntegerLit(1))), ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(>, Id(j), IntegerLit(0)), BinExpr(+, Id(c), IntegerLit(1)), BlockStmt([ReturnStmt(BinExpr(+, Id(a), FuncCall(fact, [IntegerLit(12)])))]))]))]))
])"""
    ...
    def test_program_33(self):
        ...
        expect = """Program([
	VarDecl(ABNCASDH, AutoType)
	FuncDecl(main, VoidType, [], None, BlockStmt([DoWhileStmt(BinExpr(<, Id(b), IntegerLit(9)), BlockStmt([ReturnStmt(IntegerLit(0))])), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(==, Id(i), BinExpr(-, IntegerLit(1), IntegerLit(1))), BinExpr(*, Id(a), IntegerLit(3)), ReturnStmt()), IfStmt(BinExpr(==, Id(a), BinExpr(+, IntegerLit(1), IntegerLit(1))), ReturnStmt()), BlockStmt([VarDecl(a, FloatType, FloatLit(1.231241824e-08))])]))
])"""
    ...
    def test_program_48(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, FloatType, [Param(a, AutoType), Param(b, AutoType)], None, BlockStmt([AssignStmt(Id(n), BinExpr(==, BinExpr(+, IntegerLit(10), BinExpr(/, BinExpr(*, IntegerLit(132), Id(x)), IntegerLit(10))), BinExpr(+, IntegerLit(0), Id(cn)))), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(>, Id(i), Id(n)), BinExpr(+, Id(i), IntegerLit(1)), BreakStmt()), WhileStmt(BinExpr(&&, Id(n), Id(a)), ContinueStmt()), DoWhileStmt(BinExpr(||, Id(n), Id(a)), BlockStmt([])), IfStmt(BinExpr(>, Id(n), IntegerLit(0)), BlockStmt([BlockStmt([VarDecl(var, StringType, BinExpr(::, StringLit(hello), StringLit(world)))])]), ReturnStmt(IntegerLit(0)))]))
])"""
	...
	VarDecl(ac, FloatType, FloatLit(1.2e-09))
	VarDecl(str, AutoType, StringLit(abc))
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(a), BinExpr(||, BooleanLit(True), BooleanLit(False))), BlockStmt([VarDecl(b, AutoType)])]))
])"""
	...
	VarDecl(ac, FloatType, FloatLit(1.2e-09))
	VarDecl(str, AutoType, StringLit(abc))
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(a), BinExpr(||, BooleanLit(True), BooleanLit(False))), BlockStmt([VarDecl(r, FloatType), VarDecl(s, FloatType)]), AssignStmt(Id(r), FloatLit(2.0)), AssignStmt(Id(s), BinExpr(*, BinExpr(*, Id(r), Id(r)), Id(myPi))), AssignStmt(ArrayCell(Id(a), [IntegerLit(0)]), Id(s))]))
])"""
