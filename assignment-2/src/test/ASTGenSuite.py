...
class ASTGenSuite(unittest.TestCase):
	...
	VarDecl(y, ArrayType([2], IntegerType))
	VarDecl(z, ArrayType([2], IntegerType))
])"""
    ...
    def test_program_7(self):
        ...
        expect = """Program([
	VarDecl(f, ArrayType([1], IntegerType))
])"""
    ...
    def test_program_9(self):
        ...
        expect = """Program([
	VarDecl(fa, ArrayType([4, 5], IntegerType))
])"""
    ...
    def test_program_10(self):
        ...
        expect = """Program([
	VarDecl(fac, ArrayType([4], StringType))
])"""
	...
	FuncDecl(main, VoidType, [], None, BlockStmt([None, AssignStmt(Id(var), BinExpr(::, StringLit(Lau Dai Tinh Ai), Id(var)))]))
])"""
    ...
    def test_program_15(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([AssignStmt(Id(var), BinExpr(::, StringLit(Bac), StringLit(uuu))), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(<, Id(i), BinExpr(+, Id(n), IntegerLit(1))), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1))), BlockStmt([]))]))
])"""
	...
	FuncDecl(main, VoidType, [], None, BlockStmt([None, AssignStmt(Id(var), BinExpr(::, StringLit(Lau Dai Tinh Ai), Id(var))), IfStmt(BinExpr(==, Id(n), IntegerLit(0)), BlockStmt([]), BlockStmt([]))]))
])"""
    ...
    def test_program_22(self):
        ...
        expect = """Program([
	VarDecl(var, StringType, StringLit(hello world))
	FuncDecl(main, VoidType, [], None, BlockStmt([None, AssignStmt(Id(var), BinExpr(::, StringLit(Lau Dai Tinh Ai), Id(var))), ForStmt(AssignStmt(Id(i), BinExpr(+, Id(a), Id(b))), BinExpr(<, Id(i), BinExpr(+, Id(n), IntegerLit(1))), AssignStmt(Id(i), BinExpr(-, BinExpr(+, Id(i), BinExpr(*, Id(a), Id(b))), BinExpr(/, IntegerLit(2), IntegerLit(10)))), BlockStmt([ReturnStmt(StringLit(chac khong co tren tran gian))])), CallStmt(test, IntegerLit(123), Id(ytx), BinExpr(+, BinExpr(+, BinExpr(+, IntegerLit(5), IntegerLit(2)), IntegerLit(5)), IntegerLit(5)))]))
])"""
    ...
    def test_program_25(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, AutoType, FloatLit(1.2128431e-09)), AssignStmt(Id(var), BinExpr(-, BinExpr(+, BinExpr(%, Id(se), IntegerLit(10)), IntegerLit(10)), IntegerLit(1))), WhileStmt(BinExpr(>, Id(acn), BinExpr(+, IntegerLit(10), IntegerLit(1))), BlockStmt([AssignStmt(Id(s), BinExpr(+, Id(l), IntegerLit(1))), ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(>, Id(j), IntegerLit(0)), AssignStmt(Id(c), BinExpr(+, Id(c), IntegerLit(1))), BlockStmt([ReturnStmt(BinExpr(+, Id(a), FuncCall(fact, [IntegerLit(12)])))]))]))]))
])"""
    ...
    def test_program_26(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, AutoType, FloatLit(1.2128431e-09)), AssignStmt(Id(var), BinExpr(-, BinExpr(+, BinExpr(%, Id(se), IntegerLit(10)), IntegerLit(10)), IntegerLit(1))), VarDecl(c, BooleanType, BooleanLit(False)), WhileStmt(BinExpr(>, Id(acn), BinExpr(+, IntegerLit(10), IntegerLit(1))), BlockStmt([AssignStmt(Id(s), BinExpr(+, Id(l), IntegerLit(1))), ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(>, Id(j), IntegerLit(0)), AssignStmt(Id(c), BinExpr(+, Id(c), IntegerLit(1))), BlockStmt([ReturnStmt(BinExpr(+, Id(a), FuncCall(fact, [IntegerLit(12)])))]))]))]))
])"""
    ...
    def test_program_27(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, AutoType, FloatLit(1.2128431e-09)), AssignStmt(Id(var), BinExpr(-, BinExpr(+, BinExpr(%, Id(se), IntegerLit(10)), IntegerLit(10)), IntegerLit(1))), VarDecl(a, AutoType, StringLit(string)), WhileStmt(BinExpr(>, Id(acn), BinExpr(+, IntegerLit(10), IntegerLit(1))), BlockStmt([AssignStmt(Id(s), BinExpr(+, Id(l), IntegerLit(1))), ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(>, Id(j), IntegerLit(0)), AssignStmt(Id(c), BinExpr(+, Id(c), IntegerLit(1))), BlockStmt([ReturnStmt(BinExpr(+, Id(a), FuncCall(fact, [IntegerLit(12)])))]))]))]))
])"""
    ...
    def test_program_30(self):
        ...
        expect = """Program([
	VarDecl(ABNCASDH, AutoType)
	FuncDecl(main, VoidType, [], None, BlockStmt([VarDecl(a, AutoType, FloatLit(1.2128431e-09)), AssignStmt(Id(var), BinExpr(-, BinExpr(+, BinExpr(%, Id(se), IntegerLit(10)), IntegerLit(10)), IntegerLit(1))), VarDecl(a, AutoType, StringLit(string)), AssignStmt(Id(var), BinExpr(::, BinExpr(+, StringLit(em oi ), StringLit(lau dai tinh ai)), StringLit(chac khong co tren tran gian))), WhileStmt(BinExpr(>, Id(acn), BinExpr(+, IntegerLit(10), IntegerLit(1))), BlockStmt([AssignStmt(Id(s), BinExpr(+, Id(l), IntegerLit(1))), ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(>, Id(j), IntegerLit(0)), AssignStmt(Id(c), BinExpr(+, Id(c), IntegerLit(1))), BlockStmt([ReturnStmt(BinExpr(+, Id(a), FuncCall(fact, [IntegerLit(12)])))]))]))]))
])"""
    ...
    def test_program_31(self):
        ...
        expect = """Program([
	VarDecl(ABNCASDH, AutoType)
	FuncDecl(main, VoidType, [], None, BlockStmt([None]))
])"""
    ...
    def test_program_32(self):
        ...
        expect = """Program([
	VarDecl(ABNCASDH, AutoType)
	FuncDecl(main, VoidType, [], None, BlockStmt([None, ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(==, Id(i), BinExpr(-, IntegerLit(1), IntegerLit(1))), AssignStmt(Id(a), IntegerLit(294)), ReturnStmt())]))
])"""
    ...
    def test_program_33(self):
        ...
        expect = """Program([
	VarDecl(ABNCASDH, AutoType)
	FuncDecl(main, VoidType, [], None, BlockStmt([None, ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(==, Id(i), BinExpr(-, IntegerLit(1), IntegerLit(1))), AssignStmt(Id(a), IntegerLit(294)), ReturnStmt()), IfStmt(BinExpr(==, Id(a), BinExpr(+, IntegerLit(1), IntegerLit(1))), ReturnStmt()), VarDecl(a, FloatType, FloatLit(1.231241824e-08))]))
])"""
    ...
    def test_program_35(self):
        ...
        """
        expect = """Program([
	VarDecl(integers, ArrayType([5], IntegerType))
])"""
    ...
    def test_program_43(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(n), BinExpr(==, BinExpr(+, IntegerLit(10), BinExpr(/, BinExpr(*, IntegerLit(132), Id(x)), IntegerLit(10))), BinExpr(+, IntegerLit(0), Id(cn)))), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(>, Id(i), Id(n)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1))), BreakStmt())]))
])"""
    ...
    def test_program_45(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(n), BinExpr(==, BinExpr(+, IntegerLit(10), BinExpr(/, BinExpr(*, IntegerLit(132), Id(x)), IntegerLit(10))), BinExpr(+, IntegerLit(0), Id(cn)))), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(>, Id(i), Id(n)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1))), BreakStmt()), WhileStmt(BinExpr(&&, Id(n), Id(a)), ContinueStmt()), None]))
])"""
    ...
    def test_program_47(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, FloatType, [Param(a, AutoType), Param(b, AutoType)], None, BlockStmt([AssignStmt(Id(n), BinExpr(==, BinExpr(+, IntegerLit(10), BinExpr(/, BinExpr(*, IntegerLit(132), Id(x)), IntegerLit(10))), BinExpr(+, IntegerLit(0), Id(cn)))), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(>, Id(i), Id(n)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1))), BreakStmt()), WhileStmt(BinExpr(&&, Id(n), Id(a)), ContinueStmt()), None, IfStmt(BinExpr(>, Id(n), IntegerLit(0)), BlockStmt([]), ReturnStmt(IntegerLit(0)))]))
])"""
    ...
    def test_program_48(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, FloatType, [Param(a, AutoType), Param(b, AutoType)], None, BlockStmt([AssignStmt(Id(n), BinExpr(==, BinExpr(+, IntegerLit(10), BinExpr(/, BinExpr(*, IntegerLit(132), Id(x)), IntegerLit(10))), BinExpr(+, IntegerLit(0), Id(cn)))), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(>, Id(i), Id(n)), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1))), BreakStmt()), WhileStmt(BinExpr(&&, Id(n), Id(a)), ContinueStmt()), None, IfStmt(BinExpr(>, Id(n), IntegerLit(0)), BlockStmt([VarDecl(var, StringType, BinExpr(::, StringLit(hello), StringLit(world)))]), ReturnStmt(IntegerLit(0)))]))
])"""
	...
	VarDecl(ac, FloatType, FloatLit(1.2e-09))
	VarDecl(str, AutoType, StringLit(abc))
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(a), BinExpr(||, BooleanLit(True), BooleanLit(False))), AssignStmt(ArrayCell(Id(a), [IntegerLit(0)]), BinExpr(-, BinExpr(+, BinExpr(+, IntegerLit(19), IntegerLit(123)), BinExpr(*, IntegerLit(19), IntegerLit(13))), IntegerLit(10)))]))
])"""
	...
	VarDecl(ac, FloatType, FloatLit(1.2e-09))
	VarDecl(str, AutoType, StringLit(abc))
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(a), BinExpr(||, BooleanLit(True), BooleanLit(False))), [<AST.VarDecl object at 0x000001991534EB90>]]))
])"""
    ...
    def test_program_67(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(n), FuncCall(strlen, [Id(str)])), ForStmt(AssignStmt(Id(i), IntegerLit(0)), BinExpr(<, Id(i), BinExpr(/, Id(n), IntegerLit(2))), AssignStmt(Id(i), BinExpr(+, Id(i), IntegerLit(1))), BlockStmt([CallStmt(swap, ArrayCell(str, [Id(i)]), ArrayCell(str, [BinExpr(-, BinExpr(-, Id(n), Id(i)), IntegerLit(1))]))]))]))
])"""
	...
	VarDecl(ac, FloatType, FloatLit(1.2e-09))
	VarDecl(str, AutoType, StringLit(abc))
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(a), BinExpr(||, BooleanLit(True), BooleanLit(False))), [<AST.VarDecl object at 0x000002066B44CED0>, <AST.VarDecl object at 0x000002066B44D990>], AssignStmt(Id(r), FloatLit(2.0)), AssignStmt(Id(s), BinExpr(*, BinExpr(*, Id(r), Id(r)), Id(myPi))), AssignStmt(ArrayCell(Id(a), [IntegerLit(0)]), Id(s))]))
])"""
    ...
    def test_program_96(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, FloatType, [], None, BlockStmt([AssignStmt(Id(a), StringLit(@#$\b&^@$(@(ahs\"ash\"%%@&@\"dsad\"123&^@@))]))
])"""
