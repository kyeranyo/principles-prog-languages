...
class BKOOLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BKOOLParser#equal_exp.
    def visitEqual_exp(self, ctx:BKOOLParser.Equal_expContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BKOOLParser#equal_func_call.
    def visitEqual_func_call(self, ctx:BKOOLParser.Equal_func_callContext):
        return self.visitChildren(ctx)
